...
// audit as empty for every unchanged grain. v5: summaries carry
// ContributorIDs (agent authority IRIs) -- a v4 snapshot would starve the
// enricher's authority-id resolution for unchanged grains.

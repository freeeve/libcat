...
func registerAuditCrosswalk(mux *http.ServeMux, bs blob.Store, ix *workindex.Index, vix *vocab.Index, auditLangs, providers []string, verifier auth.TokenVerifier, cws *crosswalkSource) {

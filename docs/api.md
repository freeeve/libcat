...
| `OPTIONS` | `/v1/availability/sip2` | public | `availability_handlers.go` |
| `POST` | `/v1/availability/sip2` | public | `availability_handlers.go` |
...
| `GET` | `/v1/items/duplicate-barcodes` | librarian | `maintenance_handlers.go` |
